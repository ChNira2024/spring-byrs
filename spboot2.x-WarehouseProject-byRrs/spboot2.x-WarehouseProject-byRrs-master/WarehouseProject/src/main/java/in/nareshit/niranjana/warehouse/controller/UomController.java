...
import in.nareshit.niranjana.warehouse.view.UomExcelView;
import in.nareshit.niranjana.warehouse.view.UomPdfView;
...
public class UomController 
{
	...
	public String deleteUom(@RequestParam Integer id,Model model) 
	{
		...
		//after delete,show the remained latest data and send to UI
		commonFetchAll(model);
